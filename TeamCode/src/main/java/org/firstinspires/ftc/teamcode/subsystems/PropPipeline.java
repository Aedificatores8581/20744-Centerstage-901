...
//
//    public static Side location = Side.RIGHT;
...
//
//
//        leftZoneArea = new Rect(COLOR == Side.RED? redLeftX : blueLeftX, COLOR == Side.RED? redLeftY : blueLeftY, width, height);
//        centerZoneArea = new Rect(COLOR == Side.RED?redCenterX:blueCenterX, COLOR == Side.RED?redCenterY:blueCenterY, width, height);
//
